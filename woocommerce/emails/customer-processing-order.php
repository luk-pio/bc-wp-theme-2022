...
<p style="font-size:24px;font-weight:500;color:black">
	<?php printf(esc_html__('Hi %s &mdash; Thanks for your order!', 'woocommerce'), esc_html($order->get_billing_first_name())); ?>
</p>
<?php /* translators: %s: Order number */ ?>
<p>
    <?php printf(esc_html__('We will let you know as soon as your order has been shipped and we will provide neccessary order tracking information.', 'woocommerce'), esc_html($order->get_order_number())); ?>
</p>
...
?>
<div id="line1" class="bc-divider-container">
...
<div id="line2" class="bc-divider-container">
