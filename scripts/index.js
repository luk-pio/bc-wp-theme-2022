...
function myFunction() {
    var cart1 = cart1 || document.getElementById("bc-header-cart");
    if (window.scrollY > sticky) {
        header.classList.remove("accent");
        cart1.classList.remove("accent");
        body.classList.add("sticky-header-offset");
    } else {
        header.classList.add("accent");
        cart1.classList.add("accent");
...
var swiper = new Swiper(document.getElementById("homepage-swiper-container"), {
    loop: true,
    slidesPerView: 1,
    pagination: {
        el: ".swiper-pagination",
...
},{}]},["jNtck","2mMqi"], "2mMqi", "parcelRequire203a")
