...
})({"jNtck":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = 1234;
...
},{"./form-input-animation":"2AHZL","./sticky-header":"7XwEa","./swiper-slider":"8QUph","./waiting-list":"5lNRs","./homepage-swiper-slider":"2P427"}],"2AHZL":[function(require,module,exports) {
function placeholderActive(el) {
    if (el.attr("placeholder") && el.val() === "") return true;
    return false;
}
jQuery("span:has(input:not(:placeholder-shown)) ~ span").addClass("input-selected");
...
var leftButton = document.getElementById("single-product-swiper-button-container-left");
...
jQuery(document).on("woocommerce_update_variation_values", function() {
    ...
    jQuery(".variation-radios input").each(function(index, element) {
        ...
        if (jQuery('select[name="' + thisName + '"] option[value="' + thisVal + '"]').is(":disabled")) $el.prop("disabled", true);
    });
});

},{}],"2P427":[function(require,module,exports) {
var _helpers = require("@swc/helpers");
var swiper = new Swiper(document.getElementById("homepage-swiper-container"), _helpers.defineProperty({
    loop: true,
    slidesPerView: 1,
    pagination: {
        el: ".swiper-pagination",
...
},{"./_construct":"bLTlt","./_is_native_function":"8d7fi","./_get_prototype_of":"4Z2sn","./_set_prototype_of":"hkEkh","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}]},["jNtck","2mMqi"], "2mMqi", "parcelRequire203a")
